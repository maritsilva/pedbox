    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white overflow-hidden">
        ...
        <motion.div
          ...
          <p className="text-xl text-blue-100 max-w-2xl mx-auto leading-relaxed">O conhecimento deve ser como uma hidra: vivo, descentralizado e capaz de renascer em novas versões sempre que alguém o copia, adapta e melhora.
