...
export const antibiotics = [
  ...
  {
    id: 'ceftri', name: 'Ceftriaxona', category: 'antibioticos',
    doses: [
      { label: 'Dose usual (50–75 mg/kg/dia ÷ 1)', mgPerKgPerDay: 50, maxMgPerDay: 1000, interval: 1, via: 'EV ou IM (24/24h)' },
      { label: 'Sepse/casos graves (100 mg/kg/dia ÷ 1–2)', mgPerKgPerDay: 100, maxMgPerDay: 4000, interval: 1, via: 'EV (24/24h)' },
      { label: 'Meningite – manutenção (100 mg/kg/dia ÷ 1–2)', mgPerKgPerDay: 100, maxMgPerDay: 4000, interval: 2, via: 'EV (12/12h)' },
      { label: 'Pneumonia/Epiglotite (50–100 mg/kg/dia ÷ 1–2)', mgPerKgPerDay: 75, maxMgPerDay: 4000, interval: 2, via: 'EV (12/12h)' },
      { label: 'OMA – dose única (50 mg/kg)', mgPerKgPerDay: null, mgPerKgPerDose: 50, maxMgPerDose: 1000, interval: null, via: 'IM/EV, dose única' },
      { label: 'D. de Lyme (50–75 mg/kg/dia ÷ 1)', mgPerKgPerDay: 75, maxMgPerDay: 2000, interval: 1, via: 'EV (24/24h), 2–4 semanas' },
      { label: 'Endocardite (80–100 mg/kg/dia ÷ 1–2)', mgPerKgPerDay: 100, maxMgPerDay: 4000, interval: 2, via: 'EV (12/12h), 4–6 semanas' },
    ],
    presentations: [
      { label: 'Fr. Amp. IV 500 mg (Rocefin, Triaxon, Ceftriax)', mgPerMl: null, fixedMg: 500 },
      { label: 'Fr. Amp. IV 1.000 mg (Rocefin, Triaxon, Ceftriax)', mgPerMl: null, fixedMg: 1000 },
      { label: 'Fr. Amp. IM 500 mg', mgPerMl: null, fixedMg: 500 },
      { label: 'Fr. Amp. IM 1.000 mg', mgPerMl: null, fixedMg: 1000 },
    ],
    indications: [
      'Sepse bacteriana',
      'Pneumonia comunitária grave',
      'Meningite bacteriana (> 15 dias de vida)',
      'Otite média aguda refratária (dose única IM)',
      'Epiglotite',
    ...
    notes: [
      'Cefalosporina de 3ª geração – dose única diária possível',
      'Preferir à cefotaxima em pediatria, EXCETO: RN < 15 dias, prematuros, ictéricos, colestase intensa, abscesso cerebral ou ventriculites',
      'Na meningite neonatal, associar ampicilina (cobertura para Listeria e EGB)',
      'EV: diluir para 100 mg/mL com ABD ou SF, depois rediluir para 40 mg/mL com SG/SF/RL; infundir em 5–30 min',
      'IM: diluir com lidocaína 1% s/ vasoconstritor para 350 mg/mL',
      'NÃO infundir com soluções contendo cálcio (risco de precipitação – embolia em neonatos)',
      '⚠️ CONTRAINDICADA em neonatos com icterícia grave (preferir cefotaxima)',
      'Insuficiência renal ou hepática: máximo 2 g/dia',
    ],
    observations: 'Cefalosporina de terceira geração com mesmo espectro que a cefotaxima, mas que pode ser usada em dose única diária. Boa opção em sepse, pneumonia e meningite (até a idade pré-escolar). Na meningite neonatal, associar ampicilina para cobrir Listeria e estreptococo do grupo B.',
    sensitivity: {
      resistant: [
        'Gram+: Estafilococo MRSA, Pneumococo resistente à penicilina',
        'Gram-: Listeria, Pseudomonas aeruginosa, E. coli/Klebsiella ESBL+, KPC+, Acinetobacter, Stenotrophomonas, Burkholderia cepacia, Enterobacter cloacae, Mycoplasma, Chlamydia, Legionella',
        'Anaeróbios: Bacteroides fragilis, Clostridium difficile, Prevotella melaninogenica',
      ],
      warning: 'Resistência durante o tratamento comum em: Enterobacter, P. aeruginosa, Serratia, Citrobacter, Proteus (associar aminoglicosídeo).',
    },
    sideEffects: [
      'Erupção cutânea, prurido, reações alérgicas',
      'Diarreia, colite pseudomembranosa, náuseas, vômitos',
      ...
      'Risco de precipitados com cálcio em neonatos (embolia pulmonar)',
      'Cada 1g contém 83 mg (3,6 mEq) de sódio',
    ],
    brands: [
      'Rocefin (Roche) – Fr. Amp. IV e IM: 500 e 1.000 mg',
      'Triaxin (Momenta) – Fr. Amp. IM: 500 e 1.000 mg',
      'Triaxon (Teuto) – Fr. Amp. IV e IM: 500 e 1.000 mg',
